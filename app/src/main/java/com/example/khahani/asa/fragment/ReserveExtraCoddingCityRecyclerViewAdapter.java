...
public class ReserveExtraCoddingCityRecyclerViewAdapter extends RecyclerView.Adapter<ReserveExtraCoddingCityRecyclerViewAdapter.ViewHolder> {

    private final List<Message> mValues;
    private final ReserveExtraCoddingCityFragment.OnReserveExtraListFragmentInteractionListener mListener;

    public ReserveExtraCoddingCityRecyclerViewAdapter(List<Message> items, ReserveExtraCoddingCityFragment.OnReserveExtraListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
